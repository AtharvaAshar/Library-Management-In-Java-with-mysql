...
public class Issue_book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Issued To Person");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String issuedTo=jTextField2.getText();
        String query="update books set copies =copies-1 where book_id='"+input+"'or name ='"+input+"';";
        try{
            Connection conn= DriverManager.getConnection(url,user,pwd);
            Statement stm=conn.createStatement();
            int rows= stm.executeUpdate(query);
            if(rows>0){
                JOptionPane.showMessageDialog(this,"Book issued to "+issuedTo);
            }
            else{
